...
class _Stem(nn.Sequential):
    ...
    def __init__(self, out_ch, in_ch = 2):
        super(_Stem, self).__init__()
        self.add_module("conv1", _ConvBnReLU(in_ch, out_ch, 7, 2, 3, 1))
        self.add_module("pool", nn.MaxPool2d(kernel_size=3, stride=2, padding=1, ceil_mode=True))
...
class PMNet(nn.Module):
    ...
    def __init__(self, n_blocks, atrous_rates, multi_grids, output_stride, in_ch):
