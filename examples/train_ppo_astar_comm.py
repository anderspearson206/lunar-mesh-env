"""
Experiment F — PPO training with A* navigation + RL comm.
...
Usage:
    python examples/train_ppo_astar_comm.py
    python examples/train_ppo_astar_comm.py --maps /path/to/radio_maps_hm_18.npy
"""
...
TOTAL_ITERATIONS = 50
CHECKPOINT_FREQ  = 50
EXPERIMENT_NAME  = "lunar_mesh_ppo_astar_comm"
...
def env_creator(config):
    ...
    raw_env = LunarRoverMeshAStarCommEnv(
...
register_env("lunar_mesh_astar_comm_v1", env_creator)
