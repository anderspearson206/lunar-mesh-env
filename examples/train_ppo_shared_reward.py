"""
Experiment A — PPO training with shared delivery reward.

Identical to train_ppo_mlp_gat.py except the env class is
LunarRoverMeshSharedRewardEnv, which spreads a fraction of every BS
delivery reward equally to all active agents.

Usage:
    python examples/train_ppo_shared_reward.py
    python examples/train_ppo_shared_reward.py --maps /path/to/radio_maps_hm_18.npy
"""
...
TOTAL_ITERATIONS = 50
CHECKPOINT_FREQ  = 50
EXPERIMENT_NAME  = "lunar_mesh_ppo_shared_reward"
...
def env_creator(config):
    ...
    raw_env = LunarRoverMeshSharedRewardEnv(
...
register_env("lunar_mesh_shared_reward_v1", env_creator)
