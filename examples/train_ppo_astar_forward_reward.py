...
Usage:
    python examples/train_ppo_astar_forward_reward.py
    python examples/train_ppo_astar_forward_reward.py --maps /path/to/radio_maps_hm_18.npy
"""
...
TOTAL_ITERATIONS = 50
CHECKPOINT_FREQ  = 50
EXPERIMENT_NAME  = "lunar_mesh_ppo_astar_forward_reward"
...
def env_creator(config):
    ...
    raw_env = LunarRoverMeshAStarForwardRewardEnv(
...
register_env("lunar_mesh_astar_forward_reward_v1", env_creator)
...
def build_config(obs_space, act_space, maps_path: str):
    return (
        PPOConfig()
        .environment(
            "lunar_mesh_astar_forward_reward_v1",
            env_config={
