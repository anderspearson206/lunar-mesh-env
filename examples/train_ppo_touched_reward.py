"""
Experiment D — PPO training with touched-based relay credit.
...
Usage:
    python examples/train_ppo_touched_reward.py
    python examples/train_ppo_touched_reward.py --maps /path/to/radio_maps_hm_18.npy
"""
...
TOTAL_ITERATIONS = 50
CHECKPOINT_FREQ  = 50
EXPERIMENT_NAME  = "lunar_mesh_ppo_touched_reward"
...
def env_creator(config):
    ...
    raw_env = LunarRoverMeshTouchedRewardEnv(
...
register_env("lunar_mesh_touched_reward_v1", env_creator)
